...
git clone https://github.com/Infinity-X-Devices/device_xiaomi_sm8250-common -b 15 device/xiaomi/sm8250-common --depth=1
git clone https://github.com/Infinity-X-Devices/vendor_xiaomi_alioth -b 15 vendor/xiaomi/alioth --depth=1
git clone https://github.com/Infinity-X-Devices/vendor_xiaomi_sm8250-common -b 15 vendor/xiaomi/sm8250-common --depth=1
